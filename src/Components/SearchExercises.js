...
const SearchExercises = ({ setExercises, bodyPart, setBodyPart }) => {
  ...
  useEffect(() => {
    const fetchExercisesData = async () => {
      //pass the url and the exerciseOption to the fetchData component and also take return from it and set the state that content all bodyPart data.
  ...
  const handleSearch = async () => {
    //handle search here if searching then search for the exercises and after exercises search..the search box empty 
    if (search) {
